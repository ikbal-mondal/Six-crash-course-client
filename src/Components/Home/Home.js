...
const Home = () => {
	...
	<img src="https://img.freepik.com/premium-vector/business-meeting-people-conference-flat-vector-illustration_213110-43.jpg?w=2000" alt="" className="w-5/6 mx-auto mb-12 -mt-20 rounded-lg shadow-md lg:-mt-40 dark:bg-gray-500" />
</section>
    );
};
